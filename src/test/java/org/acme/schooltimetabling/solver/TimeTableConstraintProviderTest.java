...
//    @Test
//    void roomConflict() {
//        Lesson firstLesson = new Lesson(1, "Subject1", "Group1", TIMESLOT1, ROOM1);
//        Lesson conflictingLesson = new Lesson(2, "Subject2", "Group2", TIMESLOT1, ROOM1);
//        Lesson nonConflictingLesson = new Lesson(3, "Subject3", "Group3", TIMESLOT2, ROOM1);
